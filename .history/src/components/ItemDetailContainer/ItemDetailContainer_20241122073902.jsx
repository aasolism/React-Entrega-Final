...
const ItemDetailContainer = ({ onAddToCart }) => {  // Recibimos la función onAddToCart
  ...
  return <ItemDetail product={product} onAddToCart={onAddToCart} />;  // Pasamos onAddToCart a ItemDetail
};
